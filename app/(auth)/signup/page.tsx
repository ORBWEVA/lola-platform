        ...
        {sent ? (
          ...
          <form onSubmit={signUpWithEmail} className="space-y-3">
            <input
              ...
              required
              className="w-full px-4 py-3 rounded-xl bg-card border border-glass-border text-foreground placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
            />
            <button
              type="submit"
              disabled={loading}
